...
module.exports = {
  ...
  publicPath: process.env.NODE_ENV === 'production' ? `${APP_CONFIG.ASSETS_OSS.HOST}/${APP_CONFIG.PROJECT_NAME}/` : '/', // 注最后面的斜线符号
      ...
      plugins:
        process.env.NODE_ENV !== 'production'
          ...
          : [
              ...
              new AliOSSPlugin({
                auth: {
                  accessKeyId: APP_CONFIG.ASSETS_OSS.KEY_ID,
                  accessKeySecret: APP_CONFIG.ASSETS_OSS.KEY_SECRET,
                  region: APP_CONFIG.ASSETS_OSS.REGION,
                  bucket: APP_CONFIG.ASSETS_OSS.BUCKET,
                },
